                    ...
                    <div class="layui-tab-content" style="height: 100px;">
                        <div class="layui-tab-item layui-show">
                            <table class="layui-table ">
                                ...
                                <tbody>
                                @foreach($submissionsGov as $item)
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        ...
                                        <td>
                                            ...
                                            <span class="col">{{$item->post_edit_count}}<i data-id="{{$item->id}}"
                                                                                           data-type="post-edit"
                        ...
                        <div class="layui-tab-item">
                            <table class="layui-table ">
                                ...
                                <tbody>
                                @foreach($submissionsTown as $item)
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td>{{$item->department}}</td>
                                        <td>
