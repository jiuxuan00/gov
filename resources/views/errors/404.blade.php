...
<head>
    ...
    <style type="text/css">
        ...
        .error-page-main:before{content:'';display:block;background:url({{asset('assets/img/errorPageBorder.png?1427783409637')}});height:7px;position:absolute;top:-7px;width:100%;left:0}
