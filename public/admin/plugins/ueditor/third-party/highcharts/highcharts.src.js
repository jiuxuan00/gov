...
SVGElement.prototype = {
	...
	*/
	...
	/**
	 * ApplyPublic a clipping path to this object
	 * @param {String} id
	 */
	...
	/**
	 * ApplyPublic CSS to HTML elements. This is used in text within SVG rendering and
	 * by the VML renderer
	 */
	...
	updateTransform: function () {
		...
		// ApplyPublic translate. Nearly all transformed elements have translation, so instead
...
SVGRenderer.prototype = {
	...
	color: function (color, elem, prop) {
		...
		// ApplyPublic linear or radial gradients
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		return extend(wrapper, {
			...
			/**
			 * ApplyPublic the shadow to the box
			 */
			shadow: function (b) {
				if (box) {
					box.shadow(b);
...
Highcharts.VMLElement = VMLElement = {
	...
	/**
	 * ApplyPublic a drop shadow by copying elements and giving them different strokes
	 * @param {Boolean|Object} shadowOptions
	 */
	shadow: function (shadowOptions, group, cutOff) {
		var shadows = [],
...
var VMLRendererExtension = { // inherit SVGRenderer
	...
	color: function (color, elem, prop, wrapper) {
		...
		if (fillType) {
			...
			// ApplyPublic the gradient to fills only.
			if (prop === 'fill') {
...
Tick.prototype = {
	...
	render: function (index, old, opacity) {
		...
		if (label && !isNaN(x)) {
			...
			// ApplyPublic show first and show last. If the tick is both first and last, it is
...
Point.prototype = {
	...
	/**
	 * ApplyPublic the options containing the x and y data and possible some extra properties.
